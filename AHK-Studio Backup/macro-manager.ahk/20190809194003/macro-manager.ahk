...
Menu, Tray, Add,% "Toggle Double Space", ToggleDouble
...
Loop, Parse, SectionEntries, `n
{
	...
	fn := Func("PasteText")
	Hotstring(":X:" SplitKey[1] ExtraTerminate, "PasteText")
...
ToggleDouble()
{
	...
	if (ExtraTerminate == " ")
		ExtraTerminate := ""
	Menu, Tray, ToggleCheck,% "Toggle Double Space"
	Gosub, ParseMacros
}

PasteText()
{
	Clipboard := Format({:U},ParsedIni[Trim(SubStr(A_ThisHotkey, 4))] A_EndChar)
